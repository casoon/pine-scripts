...
- **Full Mode** (17 rows) — The default view, which includes all timeframe scores plus individual Flow, Momentum, Trend, and Divergence detail rows for deeper analysis.
