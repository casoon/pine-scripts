...
| [`roc_advanced.pine`](indicators/momentum/roc_advanced/roc_advanced.pine) | Percentage Rate of Change with momentum-stretch zones, trend context, stall/absorption markers, cross conviction, and divergence wedge |
...
| [`williams_r_advanced.pine`](indicators/momentum/williams_r_advanced/williams_r_advanced.pine) | Williams %R normalized to 0-100 with fast extreme reads, trend context, stall/absorption markers, cross conviction, and divergence wedge |
